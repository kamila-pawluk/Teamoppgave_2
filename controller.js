function runtimer() {
  let timer = 15+Math.floor(Math.random() * 2);
  let max = timer;
  let interval = 100;
...
function runtimerFun() {
  let timerFun = 80+Math.floor(Math.random() * 180);
  let maxFun = timerFun;
  let interval = 100;
  let countdown = setInterval(() => {
    if(model.gameover == true){
...
function runtimerClean() {
  let timerClean = 400+Math.floor(Math.random() * 350);
...
function runtimerPet() {
  let timerPet = 10+Math.floor(Math.random() * 750);
  let maxPet = timerPet;
  let interval = 100;
  let countdown = setInterval(() => {
    if(model.gameover == true){
